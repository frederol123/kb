                ...
                <div className="header__right">
                    ...
                    <div className={`header__mobile ${menuOpen ? 'header__mobile--open' : ''}`}>
                        <nav className="header__menu">
                            <ul>
                                {user && <li><Link to="/lk" onClick={closeMenu}>Личный кабинет</Link></li>}
                    ...
                    <div className="header__user">
                        {user ? (
                            <Link to="/lk" className="contact-link header__user-link">
                                <svg className="header__user-icon" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
