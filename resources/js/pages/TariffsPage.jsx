...
const tariffDetails = [
    ...
    // 2 — Особая страница
    {
        heroSubtitle: 'Максимальный тариф: всё, что в расширенном, плюс создание видеоролика по вашим пожеланиям, генеалогическое древо и 5 генераций QR-кода со скидкой 20% на все последующие анкеты.',
        ...
        sections: [
            ...
            {
                icon: '/uploads/2024/02/icon-list-tree.svg',
                title: 'Генеалогическое древо',
                text: 'Уникальная возможность создать интерактивное генеалогическое древо прямо в профиле пользователя. Добавляйте родственников, указывайте связи, загружайте фото и документы — восстанавливайте историю вашей семьи в цифровом формате.',
            },
            {
                icon: '/uploads/2024/02/icon-list-mount.svg',
                title: 'Установка за счёт компании',
